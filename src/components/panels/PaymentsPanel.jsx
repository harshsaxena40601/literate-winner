...
export default function PaymentsPanel({
  ...
  return (
    <section className="col-span-12">
      <div className="rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-soft p-3 md:p-4">
            ...
            <tbody>
              {pageSales.map((s)=> (
                <tr key={s.id} className="border-t dark:border-neutral-800">
                  ...
                  <td className="py-2 px-2"><button onClick={()=>printReceipt(s)} className="text-sm px-2 py-1 rounded-lg border bg-soft hover:bg-bg-muted">Print</button></td>
                </tr>
              ))}
        ...
        <div className="mt-3 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <select value={pageSize} onChange={(e)=>{setPageSize(Number(e.target.value)); setPage(1);}} className="rounded-xl border px-2 py-1 bg-soft">
